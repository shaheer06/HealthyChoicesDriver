...
//   console.log(userData?.data?.imageUrl,"User ADta a")
    ...
    return (
      <View
        ...
        {!isUser && (
          <Image
            source={
              currentDriver.image || require('../assets/images/profile.png')
            }
        ...
        <Image
          source={
            userData?.data?.imageUrl
              ? {uri: `${BASE_URL}/${userData?.data?.imageUrl}`}
              : require('../assets/images/profile.png')
          }
          style={styles.driverImage}
        />
        <View style={styles.driverInfo}>
          <Text style={styles.driverName}>{userData?.data?.name}</Text>
